...
#python mapProfile.py --path ~/meTRN --organism ce --mode matrix --group regulation --peaks ce_selection_com_cx_raw --name ce_gu2012pro_TSS_gx --window 1000 --target factor.context  --spacer 50 --rename POL2:AMA-1,POLIII:RPC-1,C01312.1:C01G12.1,R0GF6.6:R06F6.6
...
#python mapProfile.py --path ~/meTRN --organism ce --mode ratios --group regulation --peaks ce_selection_com_cx_raw --name ce_gu2012pro_TSS_gx --window 1000 --target factor.context --metric signal.rng --spacer 50 --threshold SD
