...
#0.199868 (0.8001320)
#coverageBed -a ~/meTRN/data/hot/regions/maphot_dm_selection_reg_cx_occP05_any.bed -b ~/meTRN/input/flybase_dmel_r5-32_nuclear_sizes.bed -hist
#0.0359582
#coverageBed -a ~/meTRN/data/hot/regions/maphot_dm_selection_reg_cx_occP05_all.bed -b ~/meTRN/input/flybase_dmel_r5-32_nuclear_sizes.bed -hist
#0.0055493
