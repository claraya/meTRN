...
#python mapCells.py --path ~/meTRN --organism ce --mode filter --source extras --infile waterston_cell_original/tissues.csv --target waterston_cell_original/filter.csv --name waterston_cell_tissues.csv


# Import cellular expression data:
#python mapCells.py --path ~/meTRN --organism ce --mode import --infile waterston_avgExpression.csv --pedigree waterston_cell_pedigree.csv --name waterston --measure avg.expression --ascendants 5 --tissues waterston_cell_tissues.csv --mapping waterston_cell_mapping.csv --target AMA-1,LSY-2,LIN-13,MEP-1,CES-1,CEH-26,NHR-2,CEH-39,MAB-5,HLH-1,UNC-39,F23F12.9,NHR-28 --exclude LIR-2
#python mapCells.py --path ~/meTRN --organism ce --mode import --infile waterston_avgExpression.csv --pedigree waterston_cell_pedigree.csv --name waterston --measure max.expression --ascendants 5 --tissues waterston_cell_tissues.csv --mapping waterston_cell_mapping.csv --target AMA-1,LSY-2,LIN-13,MEP-1,CES-1,CEH-26,NHR-2,CEH-39,MAB-5,HLH-1,UNC-39,F23F12.9,NHR-28 --exclude LIR-2


# Inherit cellular expression down through ancestry (getting leaf cells from Murray et al. 2012):
...
# Rank and correct cellular expression estimates:
...
#python mapCells.py --path ~/meTRN --organism ce --mode cell.distance --pedigree waterston_cell_pedigree.csv --expression mapcells_avgExp_waterston_expression_tracked
#python mapCells.py --path ~/meTRN --organism ce --mode cell.distance --pedigree waterston_cell_pedigree.csv --expression mapcells_avgExp_waterston_expression_inleafs
...
# Map lineage and tissue enrichments for factors:
