...
#0.2170808 (0.7829192)
#coverageBed -a ~/meTRN/data/hot/regions/maphot_ce_selection_reg_cx_occP01_any.bed -b ~/meTRN/input/ensembl_ws220_nuclear_sizes.bed -hist
#0.0152394
#coverageBed -a ~/meTRN/data/hot/regions/maphot_ce_selection_reg_cx_occP01_all.bed -b ~/meTRN/input/ensembl_ws220_nuclear_sizes.bed -hist
#0.0030759
